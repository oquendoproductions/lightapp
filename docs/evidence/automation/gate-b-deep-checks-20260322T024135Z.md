...
Generated: 2026-03-22 02:41:35 UTC

## Worker Header Forwarding Tests

```text
[tenant-router][unknown-slug] {"host":"unknown-slug.cityreport.io","path":"/","slug":"unknown-slug","ts":"2026-03-22T02:41:35.969Z"}
✔ forwards tenant headers to upstream Pages request (9.37ms)
✔ unknown tenant does not proxy upstream and returns 404 (1.111042ms)
✔ apex root resolves marketing home (0.500083ms)
✔ apex /platform resolves platform admin (0.066792ms)
✔ assets host is passthrough and not tenant-resolved (0.05625ms)
✔ apex static assets are passthrough and not tenant redirects (0.063292ms)
✔ apex slug redirects to canonical subdomain (0.066ms)
✔ apex unknown tenant slug returns not found when known tenant set is provided (0.056125ms)
✔ subdomain serves municipality app (0.051625ms)
✔ unknown subdomain returns not found when known tenant set is provided (0.045583ms)
✔ legacy /gmaps redirects to tenant root (0.049417ms)
✔ dev host path mode resolves municipality app in staging (0.085167ms)
✔ reserved slug subdomain returns not found + event (0.689875ms)
✔ defaults tenant key for unknown host /gmaps (0.085084ms)
ℹ tests 14
ℹ suites 0
ℹ pass 14
ℹ fail 0
