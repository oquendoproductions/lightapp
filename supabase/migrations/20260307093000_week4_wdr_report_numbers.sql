...
create sequence if not exists public.report_num_wdr_seq;

grant select, usage on sequence public.report_num_wdr_seq to anon, authenticated, service_role;
grant select, usage on sequence public.report_num_wdr_seq to codex_worker;
