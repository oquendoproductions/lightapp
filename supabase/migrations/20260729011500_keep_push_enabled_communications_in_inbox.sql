-- A resident who has opted into native/web push must also be able to find the
-- delivered communication in the in-app inbox. Previously the push delivery
-- query honored web_push_enabled while the inbox RPC ignored it.
