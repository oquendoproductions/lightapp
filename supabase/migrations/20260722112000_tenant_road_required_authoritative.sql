...
update public.tenant_domain_assignments as tda
set road_required = dd.road_required
from public.domain_definitions as dd
where dd.key = tda.domain_key
  and tda.road_required is null;

update public.tenant_domain_assignments
set road_required = false
where road_required is null;

alter table public.tenant_domain_assignments
  alter column road_required set default false;

alter table public.tenant_domain_assignments
  alter column road_required set not null;
